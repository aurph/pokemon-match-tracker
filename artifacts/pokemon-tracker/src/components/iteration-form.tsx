...
export function IterationForm({ onRefresh }: { onRefresh?: () => void }) {
  ...
  async function onSubmit(e: React.FormEvent<HTMLFormElement>) {
    ...
    setPending(true);
    try {
      await api.createIteration({
        version: fd.get("version"),
        date: fd.get("date"),
        cardsIn: fd.get("cardsIn") || null,
        cardsOut: fd.get("cardsOut") || null,
        verdict: fd.get("verdict") || null,
        testedVs: fd.get("testedVs") || null,
